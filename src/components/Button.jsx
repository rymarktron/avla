...
const variantStyles = {
  solid: {
    ...
    orange: 'bg-blorangeue-600 text-white hover:text-slate-100 hover:bg-orange-500 active:bg-blorangeue-800 active:text-orange-100 focus-visible:outline-orange-600',
    white:
