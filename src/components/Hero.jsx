...
export function Hero() {
  return (
    <Container className="pt-24 pb-20 text-center lg:pt-20 lg:pb-24">
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <Image src={icons} alt="Icons" style={{ height: '60px', width: 'auto'}} />
        </div>
      <h1 className="max-w-4xl mx-auto mt-5 text-5xl font-medium tracking-tight font-display text-slate-900 sm:text-7xl">
        Online tutoring{' '}
        <span className="relative text-orange-400 whitespace-nowrap">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
      ...
      <p className="max-w-2xl mx-auto mt-6 text-lg tracking-tight text-slate-700">
        Most online tutors are not accomodating to people with learning disabilities. We make a site
        that makes it easy for people to learn.
      </p>
      <div className="flex justify-center mt-10 gap-x-6">
        ...
        >
          <svg
            aria-hidden="true"
            className="flex-none w-3 h-3 fill-orange-600 group-active:fill-current"
          >
